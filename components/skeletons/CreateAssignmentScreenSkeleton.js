...
const CreateAssignmentScreenSkeleton = () => {
    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            {/* Title */}
            <SkeletonPiece style={{ width: 220, height: 30, borderRadius: 4, marginBottom: 10 }} />
            ...
            {/* File Picker */}
            <SkeletonPiece style={{ width: 150, height: 20, borderRadius: 4, marginBottom: 10 }} />
            <SkeletonPiece style={{ width: 120, height: 40, borderRadius: 8, marginBottom: 20 }} />
