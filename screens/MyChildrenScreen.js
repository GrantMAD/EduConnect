...
const styles = StyleSheet.create({
  ...
  hero: { flexDirection: 'row', alignItems: 'center', padding: 24, borderRadius: 32, marginBottom: 24, marginHorizontal: 20 },
  ...
  adminCard: { borderRadius: 32, marginBottom: 16, overflow: 'hidden', marginHorizontal: 20 },
