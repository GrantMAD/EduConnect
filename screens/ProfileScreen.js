...
const ProfileHero = React.memo(({ bannerStyle, loading, avatarSource, borderStyle, userData, nameColorStyle, titleStyle, theme, onEdit }) => (
...
const GamificationHubCard = React.memo(({ theme, navigateToLeaderboard, navigateToShop, current_level, current_xp, xpForNextLevel, currentLevelProgress, progressPercent, streak, coins }) => (
...
const AchievementsCard = React.memo(({ theme, userData, badges }) => (
    <View style={[styles.hubCard, { backgroundColor: theme.colors.card, borderColor: theme.colors.cardBorder, borderWidth: 1 }]}>
...
const PersonalDetailsCard = React.memo(({ theme, userData }) => (
    <View style={[styles.hubCard, { backgroundColor: theme.colors.card, borderColor: theme.colors.cardBorder, borderWidth: 1 }]}>
